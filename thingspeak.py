# Denne delen er brukt for slik at Raspberry Pi-en kan kobles til thingspeak og
# deler informasjon fra sensorer til nettsiden
import requests
...
THINGSPEAK_WRITE_API_KEY = '8D0Q8XTHYLZUHW9N' # HER MÅ DERE BRUKE EGEN!!!
THINGSPEAK_WRITE_URL = f'http://api.thingspeak.com/update?api_key={THINGSPEAK_WRITE_API_KEY}'

# Tar inn sensordata og publiserer disse dataene til Thingspeak
