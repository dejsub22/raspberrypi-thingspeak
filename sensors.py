# Importerer biblioteker for å slå på sensorene
import gc
from time import sleep
from machine import Pin, I2C
import uasyncio
from BME280 import BME280
from PiicoDev_ENS160 import PiicoDev_ENS160 # Importer enhetsdriveren
from PiicoDev_Unified import sleep_ms       # En cross-platform sleep funksjon
import aht


# Setter opp kommunikasjonen med forskjellige sensorer ved hjelp av I2C-protokollen
i2c = I2C(0, scl=Pin(17), sda=Pin(16))
bme = BME280(i2c=i2c)
ens = PiicoDev_ENS160(bus=0, scl=Pin(17), sda=Pin(16))
aht_sensor = aht.AHT2x(i2c, crc=False)

# Definerer flere lister som skal brukes til å lagre målinger fra forskjellige sensorer
...
# Definerer en asynkron funksjon
async def read_bme():
...
# Oppdaterer dataene som er samlet inn fra ulike sensorer
...
# Testscript som starter en asynkron løkke og kjører 
# collect_sensors_data, som samler inn sensordata
def test():
    data = dict(
